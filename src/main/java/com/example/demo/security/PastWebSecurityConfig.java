...
//@EnableWebSecurity
//public class PastWebSecurityConfig extends WebSecurityConfigurerAdapter {
...
//        // 테스트용으로 in-memory에 계정을 임의로 생성할 때 건드는 곳
//        // -> auth.inMemoryAuthentication().withUser().password().roles() 등등
